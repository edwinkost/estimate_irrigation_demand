...
def main():
    ...
    irrig_efficiency_filename = '/projects/0/dfguu/users/edwin/data/pcrglobwb_input_aqueduct/version_2021-09-16/general/efficiency.nc'
    ...
    crop_factor_path        = '/projects/0/dfguu/users/edwin/data/pcrglobwb_input_aqueduct/version_2021-09-16/general/'
    crop_factor_files       = {'paddy'    : os.path.join(crop_factor_path, \
                                              'paddy_cropfactor_filled.nc'),\
                               'nonpaddy' : os.path.join(crop_factor_path, \
                                              'nonpaddy_cropfactor_filled.nc')}
    ...
    pot_evap_fileroot   = '/projects/0/dfguu2/users/edwin/pcrglobwb_aqueduct_2021_monthly_annual_files/version_2021-09-16/gswp3-w5e5_rerun/historical-reference/begin_from_1960/global/netcdf/referencePotET_monthTot_output%s.nc'
    pot_evap_filesuffix = '_%d-01-31_to_%d-12-31'

    # file of the monthly actual evaporation over the irrigated area
    act_evap_monthly    = True
    act_evap_fileroot   = '/projects/0/dfguu2/users/edwin/pcrglobwb_aqueduct_2021_monthly_annual_files/version_2021-09-16/gswp3-w5e5_rerun/historical-reference/begin_from_1960/global/netcdf/evaporation_from_irrigation_monthTot_output%s.nc'
    ...
    # output path
    outputpath = '/scratch-shared/rens/aqueduct_comparison/aqueduct4'
